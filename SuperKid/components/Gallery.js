...
const Gallery = () => {
    return ( 
        <>
        <Box sx={{display:"flex" , justifyContent:"center" , height:"100%", alignItems:"center" , padding:"2em 0.7em " , flexWrap:{xl:"nowrap" , xs:"wrap" , lg:"nowrap !important"} , gap:{lg:"79px" , xs:"25px" , xl:"20px"}}}>
